...
public class Exc05 {
	...
	/*
	 ...
	 5) After "throws" keyword , if you use child and parent Exception Classses to gether , it works but not recommended.
	 	because when tou use just parent it will cover the child.
